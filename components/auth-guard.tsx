...
import { hasPermission, User } from "@/lib/auth-utils"
...
const pathPermissionMap: Record<string, string> = {
  ...
  "/billing": "invoice",
  "/services": "service",
  "/employee-account": "user-management",
  "/employees": "employee",
  "/inventory": "inventory",
  "/reports": "reports",
...
export function AuthGuard({ 
  ...
  if (permission && pathname !== "/" && !hasPermission(user, permission)) {
    return (
