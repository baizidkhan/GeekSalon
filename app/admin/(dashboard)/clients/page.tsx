...
import { Plus, Search, Phone, Mail, MoreHorizontal, Upload, Download, Eye, Pencil, Trash2, User, Calendar, Calendar as CalendarIcon, Zap, Receipt, History, LayoutList, LayoutGrid, Scissors, Loader2 } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function ClientsPage() {
  ...
  const [clientFromOpen, setClientFromOpen] = useState(false)
  const [clientToOpen, setClientToOpen] = useState(false)
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        if (val.trim() && !isValidPhone(val)) phoneError = "Must be in format: 01712345678 or +8801712345678"
                ...
                <PopoverContent className="w-auto p-4">
                  <div className="space-y-3">
                    <div>
                      ...
                      <Popover open={clientFromOpen} onOpenChange={setClientFromOpen}>
                        <PopoverTrigger asChild>
                    ...
                    <div>
                      ...
                      <Popover open={clientToOpen} onOpenChange={setClientToOpen}>
                        <PopoverTrigger asChild>
                          <Button type="button" variant="outline" className="w-full justify-start px-3 font-normal">
                            <CalendarIcon className="mr-2 h-4 w-4 text-muted-foreground" />
